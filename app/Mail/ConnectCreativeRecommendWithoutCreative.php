...
class ConnectCreativeRecommendWithoutCreative extends Mailable
{
     ...
     * @return void
     */
    public function __construct($name, $looking_for, $professional_types, $project_goals)
    {
        $this->name = $name;
    ...
    public function build()
    {
        ...
        return $this->from($senderEmail, $senderName)
            ...
            ->view('email.ccRespondWithoutCreative', [
                'name' => $this->name,
