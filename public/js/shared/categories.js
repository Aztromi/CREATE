...
function setCategories2($container, $selection)
{
    if ($('#uID').length) {
        $uID = $('#uID').val(); // Assign the value of #val1 to the variable
    } 
    else {
        $uID = null; // Or any default value you'd like to assign if #val1 doesn't exist
    }
    // $selection = single or multiple
