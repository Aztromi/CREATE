            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <span id="creativeEmail" class="text-muted">{{ $user->email }}</span>
                    ...
                    <td>
                        <span hidden>{{ \Carbon\Carbon::parse($user->created_at)->format('Y/m/d') }}</span>
                        {{ \Carbon\Carbon::parse($user->created_at)->format('F d, Y') }}
                    </td>
                    <td>
                        <span hidden>{{ \Carbon\Carbon::parse($user->updated_at)->format('Y/m/d') }}</span>
                    ...
                    <td id="actions-{{ $user->id }}" class="action-holder">
                        ...
                        @if($user->status == 'active')
                            ...
                            {{-- @if($user->requests > 0)
                            <a href="">
                                <i class="fa fa-ban"></i>&ensp;Deny Request
                            </a>
                            <br>
                            @endif --}}
