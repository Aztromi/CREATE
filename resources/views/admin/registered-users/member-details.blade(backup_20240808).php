    ...
    <div class="card-body">
        <div class="container" id="main-content" style="display: none;">
            ...
            <div class="row">
                ...
                @elseif($profile->attendanceLatest && $displayType == 'exhibitor')
            ...
            <form class="mt-30" id="frm-user-account" method="POST" action="{{route('admin.edit-details.process')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    @if($displayType == 'exhibitor')
                    <div class="col-md-3 mb-4">
                        <h4>Exhibitor Status</h4>
                        <span id="lbl-exbStatus">
                            @if($profile->attendanceLatest->status == 0)
                                Incomplete
                            @elseif($profile->attendanceLatest->status == 1)
                                Approved
                            @elseif($profile->attendanceLatest->status == 2)
                                Pending
                            @elseif($profile->attendanceLatest->status == 5)
                                Denied
                            @endif
                        </span>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 mb-4">
                        <label for="org">Name of Company / Academe / Association / Group / Agency</label>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row mt-3 px-4">
                            <div class="col-12">
                                ...
                                <input type="hidden" name="jobsArr" id="jobsArr">
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <div class="row mt-3 px-4">
                            <div class="col-12">
                                ...
                                <input type="hidden" name="clientsArr" id="clientsArr">
