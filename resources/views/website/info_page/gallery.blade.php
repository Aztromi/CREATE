...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateModalImage() {
            ...
            const photoUrl = `{{ asset('img/static/x_mipam/photowall/') }}/${currentPhoto}`;
    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-sm-6 col-md-4 col-xl-3 mb-4">
                <img src="{{ asset('img/static/x_mipam/photowall/' . $photo) }}" class="img-thumbnail thumbnail" data-index="{{ $index }}" data-bs-toggle="modal" data-bs-target="#photoModal">
            </div>
            @endforeach
        </div>
    </div>
