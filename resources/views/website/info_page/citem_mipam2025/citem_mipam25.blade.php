...
@section('content')
        ...
        <div class="container-fluid text-center ahref-light">
            ...
            <div>
                <a href="https://bit.ly/3VFwMJR" class="btn-lg cta-register" target="_blank">
                    <div>REGISTER FOR PHASE II LEG 1 NOW</div>
                </a>
        ...
        <div class="content">
            ...
            <section id="schedule">
                <div class="container text-center ahref-light">
                    <div>
                        <h2 class="text-color-yellow">ENRICH YOUR SKILLS IN THE TRADE OF PERFORMING ARTS </h2>
                        <br>
                        {{-- <div class="incfs-25 mb-30">
                            <b>CLARK</b>●<b>DAPITAN</b>●<b>BOHOL</b>
                        </div> --}}
                        <p>
                            Following the successful completion of Phase I in 2024—which began in Manila and extended to regional
                        ...
                        <p>
                            This program seeks to prepare our Philippine Performing Arts Groups to do business with local and
                            international clients to be invited during the CREATEPhilippines X Manila International Performing Arts
                            Market in 2026 and beyond.
                        </p>
                        <br>
                        <h2 class="text-color-yellow">
                            <br><small class="text-color-white">PHASE II 2025</small>
                        </h2>
                        <h4>PASAY: Intensive Workshop January 30-31, 2025 
        
                            <br>Philippine Trade Training Center 
                            
                            <br>TOPICS HERE: PITCHING FOR SPECIFIC AUDIENCES, MARKET AND CLIENT ENGAGEMENT </h4>
                            <br>
                        <h3 class="ktc-title">NEXT LEGS: MARCH, JUNE </h3>
                        <a href="https://bit.ly/3VFwMJR" class="btn-lg cta-register"   target="_blank">
                            <div>REGISTER FOR PHASE II LEG 1 NOW</div>
                        </a>
    ...
    <section id="schedule">
        <div class="container text-center ahref-light">
            <div>
                <h2 class="text-color-yellow">Check Out the Results of Leg 1
                    <br><small class="text-color-white">PHASE I 2024</small>
                </h2>
                <br>
                ...
                <p>
                    <b>PHASE I</b> | Thank you for joining us at the Phase I of Navigate the Touring Circuit! Begin or Continue elevating your career in the performing arts by participating in our next training sessions. 
                </p>
                <br>
                <div>
                ...
                <div id="locationTab">
                    <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="clark-tab" data-toggle="tab" href="#clark-tab-pane"
                                role="tab" aria-controls="clark-tab-pane" aria-selected="true">
                                CLARK
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="dapitan-tab" data-toggle="tab" href="#dapitan-tab-pane" role="tab"
                                aria-controls="dapitan-tab-pane" aria-selected="false">
                                DAPITAN
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="bohol-tab" data-toggle="tab" href="#bohol-tab-pane" role="tab"
                                aria-controls="bohol-tab-pane" aria-selected="false">
                                BOHOL
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="clark-tab-pane" role="tabpanel"
                            aria-labelledby="clark-tab" tabindex="0">
                            ...
                            <div class="my-40">
                                <div class="row">
                                    <div class="col-4">
                                        <button class="btn btn-colsched btn_active" type="button" data-toggle="collapse"
                                            data-target="#multiCollapseSchedClark1" aria-expanded="true"
                                            aria-controls="multiCollapseSchedClark1" id="db_id">
                                            <b>DAY 1</b>
                                        </button>
                                    </div>
                                    <div class="col-4">
                                        <button class="btn btn-colsched" type="button" data-toggle="collapse"
                                            data-target="#multiCollapseSchedClark2" aria-expanded="false"
                                            aria-controls="multiCollapseSchedClark2" id="ds_id">
                                            <b>DAY 2</b>
                                        </button>
                                    </div>
                                    <div class="col-4">
                                        <button class="btn btn-colsched" type="button" data-toggle="collapse"
                                            data-target="#multiCollapseSchedClark3" aria-expanded="false"
                                            aria-controls="multiCollapseSchedClark3" id="hs_id">
                                            <b>DAY 3</b>
                                        </button>
                                    </div>
                                </div>
                                <div>
                                    <div>
                                        <div class="activities-holder collapse multi-collapse show"
                                            id="multiCollapseSchedClark1">
                                            <div id="schedule-clark-container-day1"></div>
                                        </div>
                                        <div class="activities-holder collapse multi-collapse"
                                            id="multiCollapseSchedClark2">
                                            <div id="schedule-clark-container-day2"></div>
                                        </div>
                                        <div class="activities-holder collapse multi-collapse"
                                            id="multiCollapseSchedClark3">
                        ...
                        <div class="tab-pane fade" id="dapitan-tab-pane" role="tabpanel" aria-labelledby="dapitan-tab"
                            tabindex="0">
                            ...
                            <div class="my-40">
                                <div class="row">
                                    <div class="col-4">
                                        <button class="btn btn-colsched btn_active" type="button" data-toggle="collapse"
                                            data-target="#multiCollapseSchedDapitan1" aria-expanded="true"
                                            aria-controls="multiCollapseSchedDapitan1" id="db_id">
                                            <b>DAY 1</b>
                                        </button>
                                    </div>
                                    <div class="col-4">
                                        <button class="btn btn-colsched" type="button" data-toggle="collapse"
                                            data-target="#multiCollapseSchedDapitan2" aria-expanded="false"
                                            aria-controls="multiCollapseSchedDapitan2" id="ds_id">
                                            <b>DAY 2</b>
                                        </button>
                                    </div>
                                    <div class="col-4">
                                        <button class="btn btn-colsched" type="button" data-toggle="collapse"
                                            data-target="#multiCollapseSchedDapitan3" aria-expanded="false"
                                            aria-controls="multiCollapseSchedDapitan3" id="hs_id">
                                            <b>DAY 3</b>
                                        </button>
                                    </div>
                                </div>
                                <div>
                                    <div>
                                        <div class="activities-holder collapse multi-collapse show"
                                            id="multiCollapseSchedDapitan1">
                                            <div id="schedule-dapitan-container-day1"></div>
                                        </div>
                                        <div class="activities-holder collapse multi-collapse"
                                            id="multiCollapseSchedDapitan2">
                                            <div id="schedule-dapitan-container-day2"></div>
                                        </div>
                                        <div class="activities-holder collapse multi-collapse"
                                            id="multiCollapseSchedDapitan3">
                        ...
                        <div class="tab-pane fade" id="bohol-tab-pane" role="tabpanel" aria-labelledby="bohol-tab"
                            tabindex="0">
                            ...
                            <div class="my-40">
                                <div class="row">
                                    <div class="col-4">
                                        <button class="btn btn-colsched btn_active" type="button" data-toggle="collapse"
                                            data-target="#multiCollapseSchedBohol1" aria-expanded="true"
                                            aria-controls="multiCollapseSchedBohol1" id="db_id">
                                            <b>DAY 1</b>
                                        </button>
                                    </div>
                                    <div class="col-4">
                                        <button class="btn btn-colsched" type="button" data-toggle="collapse"
                                            data-target="#multiCollapseSchedBohol2" aria-expanded="false"
                                            aria-controls="multiCollapseSchedBohol2" id="ds_id">
                                            <b>DAY 2</b>
                                        </button>
                                    </div>
                                    <div class="col-4">
                                        <button class="btn btn-colsched" type="button" data-toggle="collapse"
                                            data-target="#multiCollapseSchedBohol3" aria-expanded="false"
                                            aria-controls="multiCollapseSchedBohol3" id="hs_id">
                                            <b>DAY 3</b>
                                        </button>
                                    </div>
                                </div>
                                <div>
                                    <div>
                                        <div class="activities-holder collapse multi-collapse show"
                                            id="multiCollapseSchedBohol1">
                                            <div id="schedule-bohol-container-day1"></div>
                                        </div>
                                        <div class="activities-holder collapse multi-collapse"
                                            id="multiCollapseSchedBohol2">
                                            <div id="schedule-bohol-container-day2"></div>
                                        </div>
                                        <div class="activities-holder collapse multi-collapse"
                                            id="multiCollapseSchedBohol3">
            ...
            <div class="col-12 text-center">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="spk-container">
                            <img src="{{ asset('img/static/x_mipam/speakers_moderators/Tal%20de%20Guzman.png') }}"
                                alt="speakers" class="mx-auto img-fluid mb-20">
                            <p>
                                <b class="text-color-yellow">Audience Impact: Branding and Marketing for Arts
                                    Organization</b>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="spk-container">
                            <img src="{{ asset('img/static/x_mipam/speakers_moderators/Franchesca%20Casauay.png') }}"
                                alt="speakers" class="mx-auto img-fluid mb-20">
                            <p>
                                <b class="text-color-yellow">The Art of Coordination: Production Management & Event
                                    Logistics</b>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="spk-container">
                            <img src="{{ asset('img/static/x_mipam/speakers_moderators/Carmencita%20Bernardo.png') }}"
                                alt="speakers" class="mx-auto img-fluid mb-20">
                            <p>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="spk-container">
                            <img src="{{ asset('img/static/x_mipam/speakers_moderators/Joey%20Vargas.png') }}"
                                alt="speakers" class="mx-auto img-fluid mb-20">
                            <p>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="spk-container">
                            <img src="{{ asset('img/static/x_mipam/speakers_moderators/Andy%20Alviz.png') }}"
                                alt="speakers" class="mx-auto img-fluid mb-20">
                            <p>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="spk-container">
                            <img src="{{ asset('img/static/x_mipam/speakers_moderators/Peter%20De%20Vera.png') }}"
                                alt="speakers" class="mx-auto img-fluid mb-20">
                            <p>
        ...
        <div class="container">
            <div class="row text-center">
                ...
                <img src="{{ asset('img/static/x_mipam2025/organized.png') }}"
                    alt="CITEM logo with Cultural Center of the Philippines" class="mt-30 mb-50 mx-auto orgcoop-logos">
            </div>
