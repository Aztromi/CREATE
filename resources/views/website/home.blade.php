...
@section('styles')
    <style>
        #info-container .create-logo {
            height: 3em; /* Adjust this value as needed to match text height */
            width: auto; /* Maintain aspect ratio */
            margin-left: 0.5em; /* Add some space between text and image */
            margin-top: 3px;
        }
        ...
        #info-container .flip-card-back {
            background-image: url("{{ asset('img/home_about/animation.webp') }}");
            transform: rotateY(180deg);
        }
        ...
        #info-container .priority-sectors .sector-card-container:nth-child(1) .flip-card-front {
            background-image: url("{{ asset('img/home_about/animation.webp') }}");
        }

        #info-container .priority-sectors .sector-card-container:nth-child(1) .flip-card-back {
            background-image: url("{{ asset('img/home_about/animation.webp') }}");
        }

        #info-container .priority-sectors .sector-card-container:nth-child(2) .flip-card-front {
            background-image: url("{{ asset('img/home_about/communication_design.webp') }}");
        }

        #info-container .priority-sectors .sector-card-container:nth-child(2) .flip-card-back {
            background-image: url("{{ asset('img/home_about/communication_design.webp') }}");
        }

        #info-container .priority-sectors .sector-card-container:nth-child(3) .flip-card-front {
            background-image: url("{{ asset('img/home_about/game_development.webp') }}");
        }

        #info-container .priority-sectors .sector-card-container:nth-child(3) .flip-card-back {
            background-image: url("{{ asset('img/home_about/game_development.webp') }}");
        }

        #info-container .priority-sectors .sector-card-container:nth-child(4) .flip-card-front {
            background-image: url("{{ asset('img/home_about/performing_arts.webp') }}");
        }

        #info-container .priority-sectors .sector-card-container:nth-child(4) .flip-card-back {
            background-image: url("{{ asset('img/home_about/performing_arts.webp') }}");
        }

        #info-container .priority-sectors .sector-card-container:nth-child(5) .flip-card-front {
            background-image: url("{{ asset('img/home_about/visual_arts.webp') }}");
        }

        #info-container .priority-sectors .sector-card-container:nth-child(5) .flip-card-back {
            background-image: url("{{ asset('img/home_about/visual_arts.webp') }}");
        }
        ...
        #info-container .core-card-container, #info-container .sector-card-container {
            margin-bottom: 20px;
        }
        ...
        #info-container .core-values .core-card-container:nth-child(2) .core-card div:first-child {
            background-color: #3CCA92;
        }

        #info-container .core-values .core-card-container:nth-child(3) .core-card div:first-child {
            background-color: #3C9AEC;
        }

        #info-container .core-values .core-card-container:nth-child(4) .core-card div:first-child {
            background-color: #FFC906;
        }

        #info-container .core-values .core-card-container:nth-child(5) .core-card div:first-child {
            background-color: #DB87B8;
        }
            ...
            <div class="image-container">
                ...
                <div class="image">
                    <a href="{{ route('creative-works.view', ['slug' => $work->homeStoryLatest->latestSlug->value]) }}">
                        <img src="{{ asset('folder_user-uploads/' . $work->id . '/stories/' . $work->homeStoryLatest->cover_image) }}" alt="{{ $work->homeStoryLatest->latestSlug->value }}">
                    </a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 d-flex justify-content-center">
                <div class="about-head-container d-flex align-items-start">
                    <span>ABOUT</span><img src="{{ asset('img/logo.png') }}" alt="" class="img-fluid create-logo">
                     <!-- <span>ABOUT</span> <img src="{{ asset('img/createph-logo_horizontal_black.png') }}" alt="" class="img-fluid create-logo"> -->
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row mt-5">
            <div class="col-12 text-center">
                <span><h3>Your Pathway to be a Global Creative!</h3></span>
            </div>
            <div class="col-12 text-center">
        ...
        <div class="row mt-5">
            <div class="col-12 text-center">
                <span><h3>PRIORITY SECTORS</h3></span>
            </div>
            <div class="col-12 text-center">
