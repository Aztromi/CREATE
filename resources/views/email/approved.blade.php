                ...
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <p>Hello {{ $name ?? 'name' }}!</p>
                            <p>
                                We are delighted to inform you that your application to be part of the Filipino Creatives Directory has been successfully processed. You can now proceed to set up your page in the Directory and showcase your creative talents.
                            </p>
                        </td>
                        <td width="20"></td>
                    </tr>
                    ...
                    <tr>
                        <td width="20"></td>
                        <td>
                            <a href="{{ $url ?? '' }}" class="btn-verify">SETUP YOUR ACCOUNT</a>
                        </td>
                        <td width="20"></td>
                    </tr>
