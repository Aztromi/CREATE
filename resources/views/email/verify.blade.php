                ...
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            ...
                            <p>Hello,</p>
                            <p>
                                Your registration for CREATEPhilippines is almost complete. 
                            </p>
                            <p>
                                To finalize the process, please verify your email address by clicking the "VERIFY" button below. This step ensures that you have access to {{ $email }}.
                            </p>
                        </td>
                        <td width="20"></td>
                    </tr>
                    ...
                    <tr>
                        <td width="20"></td>
                        <td>
                            <a href="{{ route('register.email-verification', ['token' => $token]) }}" class="btn-verify">VERIFY</a>
                        </td>
                        <td width="20"></td>
                    </tr>
