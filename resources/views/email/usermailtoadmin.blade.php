...
<head>
    ...
    <title>CreatePhilippines User Message</title>
            ...
            <td class="content-holder">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="20"></td>
                        <td>
                            <p>CREATEPhilippines User Message</p>
                        </td>
                        <td width="20"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                <strong>Sender Name:</strong>&ensp;{{ $fname .' '. $lname }}
                                <br />
                                <strong>Sender email:</strong>&ensp;<a href="mailto:{{ $email }}">{{ $email }}</a>
                            </p>
                        </td>
                        <td width="20"></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <p>
                                <strong>Message:</strong>&ensp;{{ $msg }}
                            </p>
                        </td>
                        <td width="20"></td>
                    </tr>
                    ...
                    <tr>
                        <td width="20"></td>
                        <td>
                            <b>CREATEPhilippines Website Automated Message</b>
                        </td>
                        <td width="20"></td>
                    </tr>
                </table>
